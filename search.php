...
<body>
    ...
    <section id="abouts" class="abouts padding-top-20">
        <div class="container">
            <div class="row">
                            ...
                            <div class="single_abouts_text wow slideInRight" data- wow-duration="1s">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="product"
                                        placeholder="نام محصول مورد نظر خود را جستجو کنید" required="">
...
$pname=$_POST["product"];
$product_array = $db_handle -> runQuery("SELECT * FROM product WHERE name LIKE '%$pname%'");
...
?>
                        ...
                        <div class="abouts_content">
                            <form method="post"
                                action="shop.php?action=add&code=<?php echo $product_array[$key]["code"];?>">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="single_abouts_text wow slideInRight mine9" data-wow-duration="1s">
                                        ...
                                        <strong> قیمت </strong> <strong> <?php echo $product_array [$key]["price"]; ?>
                                            </strong> <strong> تومان </strong>
                                                <input type="text" name="quantity" value="1" size="2" /> &nbsp;&nbsp;
                                                <input class="btn btn-primary" type="submit"
                                                    value="خرید سبد به کردن اضافه " /></div>
                                    </div>
                            </form>
                        </div>
                        <?php
    ...
    $_SESSION['error']="محصولی یافت نشد";
