...
if(isset($_POST['forget'])){
 ...
 mail($to, $subject, $pass);
 echo "<script> location.href='login.php'; </script>";
 }
 }
 else{
     $_SESSION['message2']="نام کاربری ثبت نشده است";
 }
}
$conn->close();
?>
                        ...
                        <div class="col-md-12 col-sm-12 mine1">
                            ...
                            <div class="col-md-6">
                                <div class="single_widget wow fadeIn" data-wowduration="5s">
                                    <h3>برای بازیابی رمز عبور آدرس ایمیل خود را وارد کنید</h3>
                                    <h3><?php echo $_SESSION['message2']; ?></h3>
                                    <div class="single_widget_form text-right">
                                        <form name="fateme" action="forgetpassword.php" method="POST" id="formid">
                                            ...
                                            <input name="forget" type="submit" value="ارسال" class="btn btn-primary">
                                        </form>
                                    </div>
                                </div>
                            </div>
