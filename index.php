...
<body>
                    ...
                    <div class="main_slider text-center">
                        <div class="col-md-12">
                            <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                                <h1> رستوران ایتالیایی</h1>
                                <p>خوشمزه ترین و با کیفیت ترین غذاها را از ما بخواهید</p>
                                <button href="allproduct.php" class="btn-lg"> سفارش غذا </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                            ...
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک
                                ...
                                گیرد.</p>
                            <a href="" class="btn btn-primary">گالری تصاویر</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio">
        <div class="mine2 container">
            <div class="row">
                <div class="mine1  portfolio_content text-center  wow fadeIn" data-wow-duration="5s">
                    <div class="col-md-12">
                            ...
                            <div class="main_portfolio_content">
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    ...
                                    <div class="portfolio_images_overlay text-center">
                                        ...
                                        <input type="hidden" name="hidden" value="<?= $hidden=$row['id'];?>">
                                        <input type="submit" name="submit" class="btn btn-primary" value="کلیک کنید">
                        ...
                        <?php
                                ...
                                echo "در حال حاضر موردی برای نمایش وجود ندارد!";
                            }
                                $conn->close();
                            ?>
                    </div>
    ...
    <footer id="footer" class="footer">
        ...
        </div>/js/jquery-easing/jquery.easing.1.3.js"></script>
