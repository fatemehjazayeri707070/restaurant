...
if(isset($_POST['register'])){
 ...
 $sql1 = "INSERT INTO user (name, family,address, email,phone,password) VALUES ('$name','$family','$address','$email','$phone','$password')";
 if ($conn->query($sql1)===TRUE){
     /* اضافه شدن کاربر جدید به دیتابیس */
 echo "<script> location.href='login.php'; </script>";
 }
 else{
     $_SESSION['message']="خطایی رخ داده است.";
 }
 }
                            ...
                            <div class="col-md-6">
                                <div class="single_widget wow fadeIn" data-wowduration="5s">
                                    ...
                                    <div class="single_widget_form text-right">
                                        <form method="post" action="register.php" id="formid">
